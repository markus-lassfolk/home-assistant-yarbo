...
from custom_components.community_yarbo.repairs import (
...
IR_ASYNC_CREATE = "custom_components.community_yarbo.repairs.ir.async_create_issue"
IR_ASYNC_DELETE = "custom_components.community_yarbo.repairs.ir.async_delete_issue"
...
class TestMqttDisconnectRepair:
    ...
    def test_create_calls_async_create_issue(self, mock_hass: MagicMock) -> None:
        with patch(IR_ASYNC_CREATE) as mock_create:
    ...
    def test_delete_calls_async_delete_issue(self, mock_hass: MagicMock) -> None:
        with patch(IR_ASYNC_DELETE) as mock_delete:
...
class TestCoordinatorRepairIntegration:
    ...
    def test_report_controller_lost_creates_issue(self) -> None:
        ...
        with patch(
            "custom_components.community_yarbo.coordinator.async_create_controller_lost_issue"
        ) as mock_create:
    ...
    def test_resolve_controller_lost_deletes_issue(self) -> None:
        ...
        with patch(
            "custom_components.community_yarbo.coordinator.async_delete_controller_lost_issue"
        ) as mock_delete:
...
class TestCreateFixFlow:
    ...
    async def test_returns_repair_flow(self, mock_hass: MagicMock) -> None:
        ...
        from custom_components.community_yarbo.repairs import YarboRepairFlow
