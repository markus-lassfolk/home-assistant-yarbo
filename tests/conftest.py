...
_yarbo_error_reporting.init_error_reporting = lambda *args, **kwargs: None
...
def mock_yarbo_client_autouse() -> Generator[MagicMock, None, None]:
    ...
    with patch("custom_components.yarbo.YarboLocalClient", autospec=True) as mock_cls:
        ...
        client.set_head_light = AsyncMock()
        client.buzzer = AsyncMock()
        client.set_chute = AsyncMock()
        client.set_chute_steering_work = AsyncMock()
        client.set_blade_height = AsyncMock()
        client.set_blade_speed = AsyncMock()
        client.set_roller_speed = AsyncMock()
        client.set_sound = AsyncMock()
        client.set_charge_limit = AsyncMock()
        client.start_plan = AsyncMock()
        client.start_plan_direct = AsyncMock()
        ...
        client.set_turn_type = AsyncMock()
        client.push_snow_dir = AsyncMock()
