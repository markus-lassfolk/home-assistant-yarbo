...
# Telemetry polling when robot is not streaming (e.g. app closed). Match python-yarbo const: 1–3600s.
DEFAULT_POLL_INTERVAL = 10
POLL_INTERVAL_MIN = 1
POLL_INTERVAL_MAX = 3600
# When False, get_status/polling do not call get_controller (app can stay in control). python-yarbo 539526b.
